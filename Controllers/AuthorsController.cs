...
namespace LibraryAPI.Controllers
{
    ...
    public class AuthorsController : Controller
    {
        ...
        {
            if (!_propertyMappingService.ValidMappingFor<AuthorDto, Author>(authorsResourceParameters.OrderBy))
            {
                return BadRequest();
            }
            ...
            if (mediaType == "application/vnd.marvin.hateoas+json")
            {
                ...
                var shapedAuthorsWithLinks = shapedAuthors.Select(shapedAuthor =>
                {
                    var shapedAuthorAsDictionary = shapedAuthor as IDictionary<string, object>;
                    var authorLinks = CreateLinksForAuthor((Guid)shapedAuthorAsDictionary["Id"],
